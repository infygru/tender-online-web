  ...
  return (
    <main>
      ...
      <div className="max-w-6xl pt-24 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl px-4 sm:px-6 py-12 md:py-20 lg:px-8 mx-auto">
      ...
      <section className="w-full py-14 lg:flex-row flex-col gap-6 flex items-center justify-center">
        <div className="">
          <svg
            width="102"
            height="93"
          ...
          >
            <g clip-path="url(#clip0_63_2)">
              <path
                d="M1.59003 1.59009H99.97V71.4101H1.59003V1.59009Z"
                fill="#CDEBFC"
              />
              <path
                d="M71.92 40.6801C67.06 42.2501 61.89 42.6301 56.86 41.7701C48.53 40.6601 40.54 37.8001 32.29 36.2101C24.04 34.6201 15.08 34.4101 7.66003 38.3401C5.47003 39.5401 3.43003 41.0101 1.59003 42.7101V71.4001H99.97V25.8201C97.08 26.1301 94.27 26.9201 91.65 28.1701C84.6 31.5301 79.25 37.9901 71.92 40.6901V40.6801Z"
                fill="#A7DDFA"
              />
              <path
                d="M1.59003 61.8899H99.97V71.4099H1.59003V61.8899Z"
                fill="#F6F6F6"
              />
              <path
                d="M1.59003 61.8899H99.97V65.0599H1.59003V61.8899Z"
                fill="#CDCDCD"
              />
              <path
                d="M66.65 84.0999H34.91L38.08 71.4099H63.47L66.64 84.0999H66.65Z"
                fill="#CDCDCD"
              />
              <path
                d="M71.4 84.1001H30.15C29.2719 84.1001 28.56 84.812 28.56 85.6901V88.8601C28.56 89.7382 29.2719 90.4501 30.15 90.4501H71.4C72.2781 90.4501 72.99 89.7382 72.99 88.8601V85.6901C72.99 84.812 72.2781 84.1001 71.4 84.1001Z"
                fill="#F6F6F6"
              />
              <path
                d="M63.47 71.4099H38.08L37.29 74.5799H64.27L63.48 71.4099H63.47Z"
                fill="#999999"
              />
              <path d="M11.11 19.04H30.15V34.91H11.11V19.04Z" fill="#FFC247" />
              <path
                d="M25.68 19.04C25.89 21.12 25.74 23.21 25.24 25.24C24.64 27.74 22.75 29.74 20.28 30.49C19.3 30.67 18.29 30.69 17.3 30.54C15.23 30.3 13.18 29.83 11.1 29.68V34.92H30.14V19.05H25.67L25.68 19.04Z"
                fill="#FC9942"
              />
              <path
                d="M79.34 19.0399L76.17 22.2099L73 25.3799L66.65 19.0299L69.82 15.8599L72.99 12.6899L79.34 19.0399Z"
                fill="#8687C9"
              />
              <path
                d="M44.43 53.9501L34.91 57.1201L38.08 47.6001L44.43 53.9501Z"
                fill="#8687C9"
              />
              <path
                d="M72.99 25.39L57.12 41.26H52.36C50.61 41.26 49.19 42.68 49.19 44.43C49.19 45.2701 49.52 46.08 50.13 46.67C50.34 46.89 50.59 47.08 50.86 47.23L50.78 47.6101L44.43 53.96L38.08 47.6101L41.25 44.44L66.64 19.05L72.99 25.4V25.39Z"
                fill="#FFC247"
              />
              <path
                d="M99.97 30.1499V55.5399H87.28V30.1499H99.97Z"
                fill="#95E8C8"
              />
              <path
                d="M99.97 30.1499V55.5399H93.62V30.1499H99.97Z"
                fill="#06CCAB"
              />
              <path
                d="M57.13 41.26L73 25.39L76.17 22.22L87.28 33.33V52.37H66.65L61.89 47.61H52.37C51.84 47.61 51.33 47.48 50.86 47.23C50.59 47.09 50.34 46.9 50.13 46.67C49.53 46.08 49.19 45.27 49.19 44.43C49.19 42.68 50.61 41.26 52.36 41.26H57.12H57.13Z"
                fill="#FFBEAA"
              />
              <path
                d="M69.82 15.8701L66.65 19.0401L41.26 44.4301V33.3201L58.71 15.8701H69.82Z"
                fill="#FFBEAA"
              />
              <path
                d="M65.06 15.8701L64.27 16.6601L41.26 39.6701V44.4301L66.65 19.0401L69.82 15.8701H65.06Z"
                fill="#FAA68E"
              />
              <path
                d="M82.51 28.5601V46.8101H69.02L66.64 44.4301H49.19C49.19 45.2701 49.52 46.0801 50.13 46.6701C50.34 46.8901 50.59 47.0801 50.86 47.2301C51.32 47.4801 51.84 47.6101 52.37 47.6101H61.89L66.65 52.3701H87.28V33.3301L82.52 28.5701L82.51 28.5601Z"
                fill="#FAA68E"
              />
              <path
                d="M76.17 38.0801H66.65L63.48 41.2501H57.13L65.06 33.3201H72.99C74.74 33.3201 76.16 34.7401 76.16 36.4901V38.0801H76.17Z"
                fill="#FAA68E"
              />
              <path
                d="M69.82 22.2199L72.99 25.3899L76.16 22.2199L79.33 19.0499L76.16 15.8799L69.81 22.2299L69.82 22.2199Z"
                fill="#626393"
              />
              <path
                d="M34.91 57.13L44.43 53.96L41.26 50.79L34.91 57.14V57.13Z"
                fill="#626393"
              />
              <path
                d="M41.26 50.78L44.43 53.95L50.78 47.6L50.86 47.22C50.59 47.08 50.34 46.89 50.13 46.66C49.53 46.07 49.19 45.26 49.19 44.42C49.19 42.67 50.61 41.25 52.36 41.25H57.12L72.99 25.38L69.82 22.21L41.26 50.77V50.78Z"
                fill="#FC9942"
              />
              <path
                d="M99.97 0H1.59C0.71 0 0 0.71 0 1.59V71.41C0 72.29 0.71 73 1.59 73H36.05L33.67 82.52H30.15C28.4 82.52 26.98 83.94 26.98 85.69V88.86C26.98 90.61 28.4 92.03 30.15 92.03H71.41C73.16 92.03 74.58 90.61 74.58 88.86V85.69C74.58 83.94 73.16 82.52 71.41 82.52H67.89L65.51 73H99.97C100.85 73 101.56 72.29 101.56 71.41V61.89C101.56 61.01 100.85 60.3 99.97 60.3H3.17V3.17H98.38V25.39H101.55V1.59C101.55 0.71 100.84 0 99.96 0H99.97ZM71.41 88.86H30.15V85.69H71.41V88.86ZM64.61 82.51H36.94L39.32 72.99H62.23L64.61 82.51ZM98.38 63.47V69.82H3.17V63.47H98.38Z"
                fill="#252439"
              />
              <path
                d="M99.97 28.56H87.28C86.62 28.56 86.03 28.98 85.8 29.6L78.41 22.21L80.46 20.16C81.08 19.54 81.08 18.54 80.46 17.92L74.11 11.57C73.49 10.95 72.49 10.95 71.87 11.57L69.16 14.28H58.71C58.29 14.28 57.89 14.45 57.59 14.74L40.14 32.19C39.84 32.49 39.68 32.89 39.68 33.31V43.76L36.97 46.47C36.8 46.65 36.67 46.86 36.6 47.1H36.58L33.41 56.62C33.14 57.45 33.59 58.35 34.42 58.62C34.58 58.67 34.75 58.7 34.92 58.7C35.09 58.7 35.26 58.67 35.42 58.62L44.94 55.45C45.17 55.36 45.39 55.24 45.57 55.07L51.54 49.1C51.82 49.15 52.1 49.18 52.38 49.19H61.24L65.54 53.49C65.84 53.79 66.24 53.95 66.66 53.95H85.7V55.54C85.7 56.42 86.41 57.13 87.29 57.13H99.98C100.86 57.13 101.57 56.42 101.57 55.54V30.15C101.57 29.27 100.86 28.56 99.98 28.56H99.97ZM72.99 14.94L77.09 19.04L72.99 23.14L68.89 19.04L72.99 14.94ZM42.84 33.98L59.37 17.45H65.99L42.84 40.6V33.98ZM38.78 50.54L41.5 53.26L37.43 54.62L38.79 50.55L38.78 50.54ZM44.43 51.71L40.33 47.61L66.65 21.29L70.75 25.39L56.47 39.67H52.37C49.74 39.67 47.61 41.8 47.61 44.43C47.61 45.53 48 46.59 48.71 47.44L44.44 51.71H44.43ZM67.3 50.78L63 46.48C62.7 46.18 62.3 46.02 61.88 46.02H52.36C51.48 46.02 50.77 45.31 50.77 44.43C50.77 43.55 51.48 42.84 52.36 42.84H63.47C63.89 42.84 64.29 42.67 64.59 42.38L67.3 39.67H76.16V36.5H66.64C66.22 36.5 65.82 36.67 65.52 36.96L62.81 39.67H60.95L76.16 24.46L85.68 33.98V50.78H67.3ZM98.38 53.95H88.86V31.73H98.38V53.95Z"
                fill="#252439"
              />
              <path
                d="M31.74 19.0401C31.74 18.1601 31.03 17.4501 30.15 17.4501H28.56V14.2801C28.56 9.9001 25.01 6.3501 20.63 6.3501C16.25 6.3501 12.7 9.9001 12.7 14.2801V17.4501H11.11C10.23 17.4501 9.52002 18.1601 9.52002 19.0401V34.9101C9.52002 35.7901 10.23 36.5001 11.11 36.5001H30.15C31.03 36.5001 31.74 35.7901 31.74 34.9101V19.0401ZM15.87 14.2801C15.87 11.6501 18 9.5201 20.63 9.5201C23.26 9.5201 25.39 11.6501 25.39 14.2801V17.4501H15.87V14.2801ZM28.56 33.3201H12.69V20.6301H28.56V33.3201Z"
                fill="#252439"
              />
              <path d="M19.04 23.8H22.21V30.15H19.04V23.8Z" fill="#252439" />
              <path
                d="M24.27 51.2401L22.22 53.2901L18.58 49.6501C17.96 49.0301 16.96 49.0301 16.34 49.6501L12.04 53.9501H9.52002V57.1201H12.69C13.11 57.1201 13.51 56.9501 13.81 56.6601L17.45 53.0201L21.09 56.6601C21.71 57.2801 22.71 57.2801 23.33 56.6601L25.38 54.6101L27.43 56.6601C27.73 56.9601 28.13 57.1201 28.55 57.1201H31.72V53.9501H29.2L26.49 51.2401C25.87 50.6201 24.87 50.6201 24.25 51.2401H24.27Z"
                fill="#252439"
              />
              <path
                d="M9.52002 39.6699H31.74V42.8399H9.52002V39.6699Z"
                fill="#252439"
              />
              <path
                d="M92.03 6.3501H95.2V9.5201H92.03V6.3501Z"
                fill="#252439"
              />
              <path
                d="M80.93 6.3501H88.86V9.5201H80.93V6.3501Z"
                fill="#252439"
              />
              <path
                d="M85.69 12.6899H95.21V15.8599H85.69V12.6899Z"
                fill="#252439"
              />
            </g>
            <defs>
              <clipPath id="clip0_63_2">
                <rect width="101.56" height="92.03" fill="white" />
              </clipPath>
            </defs>
          </svg>
        </div>
        <div className="py-2">
          <h2 className="text-2xl font-bold lg:text-3xl lg:leading-tight text-[#1075FF]">
            Digital Signature Certificate & <br /> DSC Package
          </h2>
          <p className="mt-3 text-gray-500 dark:text-neutral-400">
            Class: 03 (Encryption + Signature)
          </p>
        </div>
        <div className="">
          <div className="h-full  space-y-4 w-max bg-white lg:mt-px lg:py-5 px-8 dark:bg-neutral-900">
            <span className="mt-7 bg-[#1D4ED8] px-6 py-1 flex flex-col font-bold text-2xl text-white rounded">
              ₹3000
            </span>
