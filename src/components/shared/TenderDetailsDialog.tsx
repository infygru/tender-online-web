...
const TenderDetailsDialog = ({ selectedRowData, setSelectedRowData }: any) => {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-3xl !rounded-3xl bg-white text-white md:overflow-y-scroll dialog-main">
        <div className="px-0 py-2 lg:px-4 ">
          <div className="rounded-3xl bg-[#000000] px-2 py-4 lg:px-4">
            ...
            <div className="">
              <h3 className="py-6 text-center text-xs font-medium lg:text-sm">
